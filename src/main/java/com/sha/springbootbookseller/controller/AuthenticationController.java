...
@RestController //rest api metodalrının içeren bir  sınıfı oldugunu belli eder
@RequestMapping("api/authentication")// tüm metodaları için defaul pre path ekleyebilmekiçin
